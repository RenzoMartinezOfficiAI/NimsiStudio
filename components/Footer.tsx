        ...
        <footer className="bg-white dark:bg-ink border-t border-gray-200 dark:border-gray-800">
            <div className="container mx-auto px-6 py-8 text-center text-slate dark:text-gray-400">
                ...
                <div className="mt-4 space-x-4 text-sm">
                    <a href="#policies" className="hover:text-pink-blush transition-colors">Policies</a>
                    <span>•</span>
                    <a href={process.env.BOOKING_PROVIDER_URL || '#'} target="_blank" rel="noopener noreferrer" className="hover:text-pink-blush transition-colors">Book Now</a>
                </div>
            </div>
        </footer>
    );
